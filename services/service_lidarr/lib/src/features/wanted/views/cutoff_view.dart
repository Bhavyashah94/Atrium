...
/// Cutoff unmet wanted albums view with infinite scrolling, sorting, filtering, and batch selection.
class CutoffView extends ConsumerStatefulWidget {
  const CutoffView({required this.instance, super.key});

  final Instance instance;

  @override
  ConsumerState<CutoffView> createState() => _CutoffViewState();
}

class _CutoffViewState extends ConsumerState<CutoffView> {
  ...
  Future<void> _fetchInitial() async {
    ...
    try {
      ...
      final AlbumResourcePagingResource data =
          unwrapLidarrApiResponse(resp, 'Failed to load cutoff unmet albums');
                ...
                children: <Widget>[
                  ...
                  Text(
                    searchQuery.trim().isNotEmpty
                        ? 'No cutoff unmet albums match "$searchQuery"'
                        : 'No cutoff unmet albums found',
