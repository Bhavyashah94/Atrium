...
class BeszelSystemDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BeszelSystemDetailScreen> createState() =>
      _BeszelSystemDetailScreenState();
}

class _BeszelSystemDetailScreenState
    extends ConsumerState<BeszelSystemDetailScreen> {
  int _currentIndex = 0;
  ...
  Widget _buildSystemStatsTab(WidgetRef ref) {
    ...
    return EasyRefresh(
      ...
      onRefresh: () async =>
          ref.refresh(beszelSystemStatsProvider(args).future),
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final availableWidth =
                      constraints.maxWidth - (8.0 * ChartTime.values.length);
                      ...
                      return Padding(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () {
                              ref.read(beszelChartTimeProvider.notifier).state =
                                  time;
                            },
                            child: Container(
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    _buildLargeStatCard(
                      ...
                      BeszelSystemCard.buildChart(
                        ...
                        secondaryEndColor: colorScheme.tertiary.withValues(
                          alpha: 0.7,
                        ),
                        showLabels: true,
                        chartTime: chartTime,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AspectRatio(aspectRatio: 1.70, child: chart),
          ],
        ),
      ),
    );
              ...
              data: (containers) {
                ...
                return SliverList(
                  delegate: SliverChildBuilderDelegate((context, index) {
                    ...
                    return _BeszelContainerCard(container: container);
  ...
  Widget _buildSystemdStatsTab(WidgetRef ref) {
    ...
    return EasyRefresh(
      ...
      onRefresh: () async =>
          ref.refresh(beszelSystemdServicesProvider(args).future),
      child: CustomScrollView(
        physics: const AlwaysScrollableScrollPhysics(),
        slivers: [
          const HeaderLocator.sliver(),
...
class _BeszelSystemdServiceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isRunning =
        service.state == 0 || service.sub == 1; // 0=Active, 1=Running
    final colorScheme = Theme.of(context).colorScheme;
            ...
            GridView.count(
              ...
              children: [
                _buildStatItem(
                  ...
                  Icons.memory,
                  'CPU',
                  '${service.cpu.toStringAsFixed(1)}%',
                ),
                _buildStatItem(
                  context,
                  Icons.storage,
                  'Memory',
                  _formatBytes(service.memory),
                ),
              ],
            ),
          ],
...
class _BeszelContainerCard extends StatelessWidget {
  const _BeszelContainerCard({required this.container});
            ...
            GridView.count(
              ...
              children: [
                _buildStatItem(
                  ...
                  Icons.memory,
                  'CPU',
                  '${(container.cpu ?? 0.0).toStringAsFixed(1)}%',
                ),
                _buildStatItem(
                  context,
                  Icons.storage,
                  'Memory',
                  '${(container.memory ?? 0.0).toStringAsFixed(1)} MB',
                ),
                _buildStatItem(
                  context,
                  Icons.network_check,
                  'Net',
                  _formatNetworkTraffic(container.net),
                ),
              ],
            ),
            if (container.image != null && container.image!.isNotEmpty) ...[
