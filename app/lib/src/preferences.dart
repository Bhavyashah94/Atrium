...
class Preferences {
  const Preferences({
    ...
    this.paletteStyle = PaletteStyle.material,
  ...
  Preferences build() {
    return Preferences(
      ...
      paletteStyle: switch (_box.get(_paletteStyleKey)) {
        'material' || 'tonalSpot' => PaletteStyle.material,
        'vivid' || 'content' => PaletteStyle.vivid,
        'highContrast' || 'expressive' => PaletteStyle.highContrast,
        'candyPop' || 'fidelity' => PaletteStyle.candyPop,
        'jolly' || 'fruitSalad' => PaletteStyle.jolly,
        'oneHue' || 'monochrome' => PaletteStyle.oneHue,
        'chroma' || 'neutral' => PaletteStyle.chroma,
        'ultraContrast' || 'rainbow' => PaletteStyle.ultraContrast,
        _ => PaletteStyle.material,
      },
